...
import { createShopInformationSchema, updateShopInformationSchema } from "./shipping.schema.js";
...
router.post("/createShippingInformation", validBodyRequest(createShopInformationSchema), createShippingInformation)
router.patch("/:id", validBodyRequest(updateShopInformationSchema), updateShippingInformation)
