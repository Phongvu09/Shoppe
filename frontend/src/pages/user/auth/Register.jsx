...
export default function Register() {
  ...
  const onSubmit = async (e) => {
    ...
    //   setErrMsg(err.response?.data?.message || "Đăng ký thất bại. Vui lòng thử lại.");
    // } finally {
    //   setLoading(false);
    // }
    // ```
  ...
  return (<div className="max-w-md mx-auto p-6"> <h1 className="text-2xl font-semibold mb-4">Đăng ký</h1>
